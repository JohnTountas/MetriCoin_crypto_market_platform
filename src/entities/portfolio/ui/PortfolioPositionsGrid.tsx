...
export const PortfolioPositionsGrid = ({ positions }: PortfolioPositionsGridProps) => {
            ...
            >
              ...
              <div className="mt-6 grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <p className="mt-1 font-semibold text-[var(--text-primary)]">{formatCurrency(position.currentValue)}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="mt-1 font-semibold text-[var(--text-primary)]">{formatPrice(position.averageCost)}</p>
                </div>
                <div>
                  <p className="text-[var(--text-faint)]">Break-even</p>
                  <p className="mt-1 font-semibold text-[var(--text-primary)]">{formatPrice(position.breakEvenPrice)}</p>
                </div>
              </div>
